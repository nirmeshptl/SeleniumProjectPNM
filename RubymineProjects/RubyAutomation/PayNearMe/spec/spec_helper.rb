...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    @driver.get "https://www.paynearme.com/consumers/#/register"
     ...
     #@randNum=Random.new
     #@signup_phnum=@r.rand().to_s[2..11]

     #random_string=@r.srand(1..99999).to_s
     #@signup_email="test+#{random_string}@gmail.com"

    #wait_true = Selenium::WebDriver::Wait.new(:timeout => 15)
  end
